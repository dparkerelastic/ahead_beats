...
*`horizon.connection_server.name`*::
+
--
type: keyword
...
*`horizon.connection_server.status`*::
+
--
type: keyword
...
*`horizon.connection_server.connection_count`*::
+
--
type: long
...
*`horizon.connection_server.tunnel_connection_count`*::
+
--
type: long
...
*`horizon.connection_server.default_certificate`*::
+
--
type: boolean
...
*`horizon.connection_server.certificate.valid`*::
+
--
type: boolean
...
*`horizon.connection_server.certificate.valid_from`*::
+
--
type: date
...
*`horizon.connection_server.certificate.valid_to`*::
+
--
type: date
...
*`horizon.connection_server.details.version`*::
+
--
type: keyword
...
*`horizon.connection_server.details.build`*::
+
--
type: keyword
...
*`horizon.desktop_pool.display_name`*::
+
--
type: keyword
...
*`horizon.desktop_pool.description`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.delete_in_progress`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.enable_client_restrictions`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.allow_multiple_sessions_per_user`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.session_type`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.cloud_managed`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.cloud_assigned`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.session_settings.power_policy`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.session_settings.disconnected_session_timeout_policy`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.session_settings.disconnected_session_timeout_minutes`*::
+
--
type: integer
...
*`horizon.desktop_pool.settings.session_settings.allow_users_to_reset_machines`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.session_settings.allow_multiple_sessions_per_user`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.session_settings.delete_or_refresh_machine_after_logoff`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.session_settings.refresh_os_disk_after_logoff`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.display_protocol_settings.display_protocols`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.display_protocol_settings.default_display_protocol`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.display_protocol_settings.allow_users_to_choose_protocol`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.display_protocol_settings.html_access_enabled`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.display_protocol_settings.session_collaboration_enabled`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.display_protocol_settings.renderer3d`*::
+
--
type: keyword
...
*`horizon.desktop_pool.settings.display_protocol_settings.grid_vgpus_enabled`*::
+
--
type: boolean
...
*`horizon.desktop_pool.settings.display_protocol_settings.max_number_of_monitors`*::
+
--
type: integer
...
*`horizon.desktop_pool.settings.display_protocol_settings.max_resolution_of_any_one_monitor`*::
+
--
type: keyword
...
*`horizon.desktop_pool.installed_application.name`*::
+
--
type: keyword
...
*`horizon.desktop_pool.installed_application.version`*::
+
--
type: keyword
...
*`horizon.desktop_pool.installed_application.publisher`*::
+
--
type: keyword
...
*`horizon.desktop_pool.installed_application.executable_path`*::
+
--
type: keyword
...
*`horizon.desktop_pool.installed_application.file_types`*::
+
--
type: flattened
...
*`horizon.session.broker_user_id`*::
+
--
type: keyword
...
*`horizon.session.access_group_id`*::
+
--
type: keyword
...
*`horizon.session.desktop_pool_id`*::
+
--
type: keyword
...
*`horizon.session.client_data.location_id`*::
+
--
type: keyword
...
*`horizon.session.client_data.type`*::
+
--
type: keyword
...
*`horizon.session.client_data.address`*::
+
--
type: keyword
...
*`horizon.session.client_data.name`*::
+
--
type: keyword
...
*`horizon.session.client_data.version`*::
+
--
type: keyword
...
*`horizon.session.security_gateway_data.domain_name`*::
+
--
type: keyword
...
*`horizon.session.security_gateway_data.address`*::
+
--
type: keyword
...
*`horizon.session.security_gateway_data.location`*::
+
--
type: keyword
...
*`horizon.session.session_protocol`*::
+
--
type: keyword
...
*`horizon.session.disconnected_time`*::
+
--
type: date
...
*`horizon.session.last_session_duration`*::
+
--
type: long
...
*`horizon.session.resourced_remotely`*::
+
--
type: boolean
...
*`horizon.session.unauthenticated`*::
+
--
type: boolean
...
*`horizon.gateway.active_connection_count`*::
+
--
type: long
...
*`horizon.gateway.pcoip_connection_count`*::
+
--
type: long
...
*`horizon.gateway.blast_connection_count`*::
+
--
type: long
...
*`horizon.gateway.details.address`*::
+
--
type: keyword
...
*`horizon.gateway.details.internal`*::
+
--
type: boolean
...
*`horizon.gateway.details.version`*::
+
--
type: keyword
...
*`horizon.virtual_center.version`*::
+
--
type: keyword
...
*`horizon.virtual_center.description`*::
+
--
type: keyword
...
*`horizon.virtual_center.instance_uuid`*::
+
--
type: keyword
...
*`horizon.virtual_center.server_name`*::
+
--
type: keyword
...
*`horizon.virtual_center.use_ssl`*::
+
--
type: boolean
...
*`horizon.virtual_center.user_name`*::
+
--
type: keyword
...
*`horizon.virtual_center.se_sparse_reclamation_enabled`*::
+
--
type: boolean
...
*`horizon.virtual_center.enabled`*::
+
--
type: boolean
...
*`horizon.virtual_center.vmc_deployment`*::
+
--
type: boolean
...
*`horizon.virtual_center.limits.provisioning_limit`*::
+
--
type: integer
...
*`horizon.virtual_center.limits.power_operations_limit`*::
+
--
type: integer
...
*`horizon.virtual_center.limits.instant_clone_engine_provisioning_limit`*::
+
--
type: integer
...
*`horizon.virtual_center.storage_accelerator_data.enabled`*::
+
--
type: boolean
...
*`horizon.virtual_center.storage_accelerator_data.default_cache_size_mb`*::
+
--
type: integer
...
*`horizon.virtual_center.certificate_override.certificate`*::
+
--
type: keyword
...
*`horizon.virtual_center.certificate_override.type`*::
+
--
type: keyword
...
*`horizon.machine.desktop_pool_id`*::
+
--
type: keyword
...
*`horizon.machine.operating_system`*::
+
--
type: keyword
...
*`horizon.machine.operating_system_architecture`*::
+
--
type: keyword
...
*`horizon.machine.agent_build_number`*::
+
--
type: keyword
...
*`horizon.machine.remote_experience_agent_build_number`*::
+
--
type: keyword
...
*`horizon.machine.message_security_mode`*::
+
--
type: keyword
...
*`horizon.machine.message_security_enhanced_mode_supported`*::
+
--
type: boolean
...
*`horizon.machine.configured_by_connection_server`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.virtual_center_id`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.host_name`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.path`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.virtual_machine_power_state`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.storage_accelerator_state`*::
+
--
type: keyword
...
*`horizon.machine.managed_machine_data.memory_mb`*::
+
--
type: integer
...
*`horizon.machine.managed_machine_data.missing_in_vcenter`*::
+
--
type: boolean
...
*`horizon.machine.managed_machine_data.in_hold_customization`*::
+
--
type: boolean
...
*`horizon.machine.managed_machine_data.create_time`*::
+
--
type: date
...
*`horizon.machine.managed_machine_data.in_maintenance_mode`*::
+
--
type: boolean
...
*`horizon.machine.managed_machine_data.health.example`*::
+
--
Example field
