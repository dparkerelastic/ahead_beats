...
|<<metricbeat-module-horizon,Horizon module>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-horizon-health,health>> beta[]  
...
include::modules/horizon.asciidoc[]
