...
|<<metricbeat-module-citrix_cms,citrix_cms>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-citrix_cms-health,health>> beta[]  
...
|<<metricbeat-module-dellecs,dellecs>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-dellecs-health,health>> beta[]  
...
|<<metricbeat-module-emcunity,emcunity>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-emcunity-health,health>> beta[]  
...
|<<metricbeat-module-purestorage,purestorage>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.2+| .2+|  |<<metricbeat-metricset-purestorage-arrays,arrays>> beta[]  
|<<metricbeat-metricset-purestorage-health,health>> beta[]  
...
include::modules/citrix_cms.asciidoc[]
...
include::modules/purestorage.asciidoc[]
