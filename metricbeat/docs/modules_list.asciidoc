...
|<<metricbeat-module-daptest,daptest>>  beta[]   |image:./images/icon-no.png[No prebuilt dashboards]    |  
.1+| .1+|  |<<metricbeat-metricset-daptest-test,test>> beta[]  
...
include::modules/daptest.asciidoc[]
